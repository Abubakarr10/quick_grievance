...
import 'package:quick_grievance/screens/admin/setting/setting_screen.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Obx(() => AppTextWidget(
              title: controller.navTitles[controller.selectedIndex.value],
              color: pureWhite,
        ...
        child: Column(
          children: [
            const UserAccountsDrawerHeader(
              ...
              accountName: AppTextWidget(
                title: 'Warden',
                color: pureWhite,
              ),
              accountEmail: AppTextWidget(
                title: 'warden.admin@quick.com',
                color: pureWhite,
              ),
            ...
            ...List.generate(controller.navTitles.length, (index) {
              return Obx(() => ListTile(
                    ...
                    title: AppTextWidget(
                      title: controller.navTitles[index],
